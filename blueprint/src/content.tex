...
\begin{proposition}
  ...
  %
  \uses{def:numDistinctColoringsOfNecklace, def:computeNumDistinctColorings}
  %
...
\begin{proposition}
  ...
  %
  \uses{def:numDistinctColoringsOfBracelet, def:MulActionBracelet, def:computeNumDistinctColorings}
  %
...
\begin{proposition}
  ...
  %
  \uses{def:numDistinctColoringsOfCube, prop:RotationalSymmetriesOfCubeSubgroup, def:computeNumDistinctColorings}
  %
